...
def show_flow2(image_nr_1, image_nr_2):#, image_dir_name = './image_sequence_pure_ver1/', image_prefix='image_', image_type = 'jpg'):
    #image_name_1 = image_dir_name + image_prefix + str(image_nr_1) + '.' + image_type;
    #prev_bgr = cv2.imread(image_name_1);
    prev_bgr = image_nr_1;
    bgr = image_nr_2;
